  ...
  stages {
    ...
    stage('Deploy in Minikube'){
      steps {
        ...
        sh 'sudo su - cicd-vm1 -c "/home/cicd-vm1/.minikube/cache/linux/amd64/v1.26.3/kubectl apply -f  /var/lib/jenkins/workspace/ins-kubernetes-deployment_master/service.yaml"'
    }
      }
  }
  post {
